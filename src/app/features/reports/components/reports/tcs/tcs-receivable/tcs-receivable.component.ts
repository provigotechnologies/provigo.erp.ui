...
@Component({
  selector: 'app-tcs-receivable',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './tcs-receivable.component.html',
  styleUrls: [
    './tcs-receivable.component.css',
    '../../../../../styles/report-style.css'
  ]
})
export class TcsReceivableComponent implements OnInit {  // Implement OnInit here
  fromDate: string = '';
  toDate: string = '';
