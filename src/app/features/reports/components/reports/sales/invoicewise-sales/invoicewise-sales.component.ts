...
@Component({
  selector: 'app-invoicewise-sales',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './invoicewise-sales.component.html',
  styleUrls: [
    './invoicewise-sales.component.css',
    '../../../../../styles/report-style.css'
  ]
})
export class InvoicewiseSalesComponent implements OnInit {  // Implement OnInit here
  fromDate: string = '';
  toDate: string = '';
