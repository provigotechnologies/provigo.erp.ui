...
@Component({
  selector: 'app-gstr-indirect-expense',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './gstr-indirect-expense.component.html',
  styleUrls: [
    './gstr-indirect-expense.component.css',
    '../../../../../styles/report-style.css'
  ]
})
export class GstrIndirectExpenseComponent implements OnInit {  // Implement OnInit here
  fromDate: string = '';
  toDate: string = '';
