...
@Component({
  selector: 'app-itemwise-purchase-summary',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './itemwise-purchase-summary.component.html',
  styleUrls: [
    './itemwise-purchase-summary.component.css',
    '../../../../../styles/report-style.css'
  ]
})
export class ItemwisePurchaseSummaryComponent implements OnInit {  // Implement OnInit here
  fromDate: string = '';
  toDate: string = '';
