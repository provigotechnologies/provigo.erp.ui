...
@Component({
  selector: 'app-tcs-payable',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './tcs-payable.component.html',
  styleUrls: [
    './tcs-payable.component.css',
    '../../../../../styles/report-style.css'
  ]
})
export class TcsPayableComponent implements OnInit {  // Implement OnInit here
  fromDate: string = '';
  toDate: string = '';
