...
@Component({
  selector: 'app-gst-sales',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './gst-sales.component.html',
  styleUrls: [
    './gst-sales.component.css',
    '../../../../../styles/report-style.css'
  ]
})
export class GstSalesComponent implements OnInit {  // Implement OnInit here
  fromDate: string = '';
  toDate: string = '';
