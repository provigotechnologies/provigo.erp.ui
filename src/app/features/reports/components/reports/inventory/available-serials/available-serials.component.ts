...
@Component({
  selector: 'app-available-serials',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './available-serials.component.html',
  styleUrls: [
    './available-serials.component.css',
    '../../../../../styles/report-style.css'
  ]
})
export class AvailableSerialsComponent implements OnInit {  // Implement OnInit here
  fromDate: string = '';
  toDate: string = '';
