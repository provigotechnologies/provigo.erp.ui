...
@Component({
  selector: 'app-supplierwise-purchase-summary',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './supplierwise-purchase-summary.component.html',
  styleUrls: [
    './supplierwise-purchase-summary.component.css',
    '../../../../../styles/report-style.css'
  ]
})
export class SupplierwisePurchaseSummaryComponent implements OnInit {  // Implement OnInit here
  fromDate: string = '';
  toDate: string = '';
