...
@Component({
  selector: 'app-itemwise-sales-summary',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './itemwise-sales-summary.component.html',
  styleUrls: [
    './itemwise-sales-summary.component.css',
    '../../../../../styles/report-style.css'
  ]
})
export class ItemwiseSalesSummaryComponent implements OnInit {  // Implement OnInit here
  fromDate: string = '';
  toDate: string = '';
