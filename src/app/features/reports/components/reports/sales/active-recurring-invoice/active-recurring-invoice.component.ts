...
@Component({
  selector: 'app-active-recurring-invoice',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './active-recurring-invoice.component.html',
  styleUrls: [
    './active-recurring-invoice.component.css',
    '../../../../../styles/report-style.css'
  ]
})
export class ActiveRecurringInvoiceComponent implements OnInit {  // Implement OnInit here
  fromDate: string = '';
  toDate: string = '';
