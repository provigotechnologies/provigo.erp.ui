...
@Component({
  selector: 'app-items-not-moving',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './items-not-moving.component.html',
  styleUrls: [
    './items-not-moving.component.css',
    '../../../../../styles/report-style.css'
  ]
})
export class ItemsNotMovingComponent implements OnInit {  // Implement OnInit here
  fromDate: string = '';
  toDate: string = '';
