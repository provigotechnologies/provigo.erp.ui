...
@Component({
  selector: 'app-invoicewise-profit-margin',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './invoicewise-profit-margin.component.html',
  styleUrls: [
    './invoicewise-profit-margin.component.css',
    '../../../../../styles/report-style.css'
  ]
})
export class InvoicewiseProfitMarginComponent implements OnInit {  // Implement OnInit here
  fromDate: string = '';
  toDate: string = '';
