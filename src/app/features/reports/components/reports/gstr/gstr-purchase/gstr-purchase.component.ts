...
@Component({
  selector: 'app-gstr-purchase',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './gstr-purchase.component.html',
  styleUrls: [
    './gstr-purchase.component.css',
    '../../../../../styles/report-style.css'
  ]
})
export class GstrPurchaseComponent implements OnInit {  // Implement OnInit here
  fromDate: string = '';
  toDate: string = '';
