...
@Component({
  selector: 'app-purchase-aging',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './purchase-aging.component.html',
  styleUrls: [
    './purchase-aging.component.css',
    '../../../../../styles/report-style.css'
  ]
})
export class PurchaseAgingComponent implements OnInit {  // Implement OnInit here
  fromDate: string = '';
  toDate: string = '';
