...
@Component({
  selector: 'app-invoicewise-sales-summary',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './invoicewise-sales-summary.component.html',
  styleUrls: [
    './invoicewise-sales-summary.component.css',
    '../../../../../styles/report-style.css'
  ]
})
export class InvoicewiseSalesSummaryComponent implements OnInit {  // Implement OnInit here
  fromDate: string = '';
  toDate: string = '';
