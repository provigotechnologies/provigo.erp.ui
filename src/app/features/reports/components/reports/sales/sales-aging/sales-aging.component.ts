...
@Component({
  selector: 'app-sales-aging',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './sales-aging.component.html',
  styleUrls: [
    './sales-aging.component.css',
    '../../../../../styles/report-style.css'
  ]
})
export class SalesAgingComponent implements OnInit {  // Implement OnInit here
  fromDate: string = '';
  toDate: string = '';
