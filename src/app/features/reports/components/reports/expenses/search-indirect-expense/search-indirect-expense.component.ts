...
@Component({
  selector: 'app-search-indirect-expense',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './search-indirect-expense.component.html',
  styleUrls: [
    './search-indirect-expense.component.css',
    '../../../../../styles/report-style.css'
  ]
})
export class SearchIndirectExpenseComponent implements OnInit {  // Implement OnInit here
  fromDate: string = '';
  toDate: string = '';
