...
@Component({
  selector: 'app-billwise-purchase-summary',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './billwise-purchase-summary.component.html',
  styleUrls: [
    './billwise-purchase-summary.component.css',
    '../../../../../styles/report-style.css'
  ]
})
export class BillwisePurchaseSummaryComponent implements OnInit {  // Implement OnInit here
  fromDate: string = '';
  toDate: string = '';
