...
@Component({
  selector: 'app-input-output-tax',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './input-output-tax.component.html',
  styleUrls: [
    './input-output-tax.component.css',
    '../../../../../styles/report-style.css'
  ]
})
export class InputOutputTaxComponent implements OnInit {  // Implement OnInit here
  fromDate: string = '';
  toDate: string = '';
