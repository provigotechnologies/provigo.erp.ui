...
@Component({
  selector: 'app-gstr-sale',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './gstr-sale.component.html',
  styleUrls: [
    './gstr-sale.component.css',
    '../../../../../styles/report-style.css'
  ]
})
export class GstrSaleComponent implements OnInit {  // Implement OnInit here
  fromDate: string = '';
  toDate: string = '';
