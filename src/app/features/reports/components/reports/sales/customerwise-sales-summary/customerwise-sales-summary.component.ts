...
@Component({
  selector: 'app-customerwise-sales-summary',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './customerwise-sales-summary.component.html',
  styleUrls: [
    './customerwise-sales-summary.component.css',
    '../../../../../styles/report-style.css'
  ]
})
export class CustomerwiseSalesSummaryComponent implements OnInit {  // Implement OnInit here
  fromDate: string = '';
  toDate: string = '';
