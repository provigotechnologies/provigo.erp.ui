...
@Component({
  selector: 'app-itemwise-profit-margin',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './itemwise-profit-margin.component.html',
  styleUrls: [
    './itemwise-profit-margin.component.css',
    '../../../../../styles/report-style.css'
  ]
})
export class ItemwiseProfitMarginComponent implements OnInit {  // Implement OnInit here
  fromDate: string = '';
  toDate: string = '';
