...
@Component({
  selector: 'app-customerwise-profit-margin',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './customerwise-profit-margin.component.html',
  styleUrls: [
    './customerwise-profit-margin.component.css',
    '../../../../../styles/report-style.css'
  ]
})
export class CustomerwiseProfitMarginComponent implements OnInit {  // Implement OnInit here
  fromDate: string = '';
  toDate: string = '';
